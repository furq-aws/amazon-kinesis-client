...
public class ShardInfoTest {
    ...
    public void testPacboyShardInfoEqualsForfToken() {
        ...
        assertFalse("Equal should return false with different concurrency token", diffShardInfo.equals(testShardInfo));
    ...
    public void testPacboyShardInfoEqualsForDifferentlyOrderedParentIds() {
        ...
        ShardInfo shardInfoWithDifferentlyOrderedParentShardIds = new ShardInfo(
                SHARD_ID, CONCURRENCY_TOKEN, differentlyOrderedParentShardIds, ExtendedSequenceNumber.LATEST);
        assertTrue(
                "Equal should return true even with parent shard Ids reordered",
    ...
    public void testPacboyShardInfoEqualsForParentIds() {
        ...
        ShardInfo diffShardInfo =
                new ShardInfo(SHARD_ID, CONCURRENCY_TOKEN, diffParentIds, ExtendedSequenceNumber.LATEST);
        assertFalse("Equal should return false with different parent shard Ids", diffShardInfo.equals(testShardInfo));
    ...
    public void testShardInfoCheckpointEqualsHashCode() {
        ...
        ShardInfo differentCheckpoint =
                new ShardInfo(SHARD_ID, CONCURRENCY_TOKEN, parentShardIds, new ExtendedSequenceNumber("1234"));
        ...
        assertThat(
                "Checkpoint should not be included in hash code.",
                baseInfo.hashCode(),
    ...
    public void testPacboyShardInfoSameHashCode() {
        ShardInfo equalShardInfo =
                new ShardInfo(SHARD_ID, CONCURRENCY_TOKEN, parentShardIds, ExtendedSequenceNumber.LATEST);
        assertTrue(
                "Shard info objects should have same hashCode for the same arguments",
