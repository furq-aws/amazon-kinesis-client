...
public class SchedulerTest {
    ...
    public void setup() {
        ...
        leaseManagementConfig = new LeaseManagementConfig(tableName, applicationName, dynamoDBClient, kinesisClient,
            workerIdentifier)
                .leaseManagementFactory(new TestKinesisLeaseManagementFactory(false, false))
                .workerUtilizationAwareAssignmentConfig(new WorkerUtilizationAwareAssignmentConfig().disableWorkerMetrics(true)
