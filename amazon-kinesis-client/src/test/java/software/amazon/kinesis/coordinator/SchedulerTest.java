...
public class SchedulerTest {
    ...
    public void testShardInfoConstructionFromSingleStreamLease() {
        ...
        // checkpoint is not included in ShardInfo equality
    ...
    public void testShardInfoConstructionFromMultiStreamLeases() {
        ...
        assertNotSame(streamConfigForOrphanStream, shardInfoArgumentCaptor.getAllValues().get(2).streamConfig());
        assertEquals(streamConfigForOrphanStream.streamIdentifier(),
                shardInfoArgumentCaptor.getAllValues().get(2).streamConfig().streamIdentifier());
    }
